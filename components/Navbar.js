        ...
        {roomId && 
          <div className='flex justify-between items-center font-bold relative'>
            ...
            <button className='bg-cyan-200 p-[5px] rounded-[5px] mx-[10px] text-black' onClick={handlePauseClick}>
              {paused ?
                <svg width="24" height="24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M6 9a1 1 0 0 1 1 1c0 1.42.242 2.947.969 4.088C8.648 15.156 9.819 16 12 16c2.181 0 3.352-.845 4.031-1.912C16.758 12.947 17 11.42 17 10a1 1 0 1 1 2 0c0 1.58-.258 3.553-1.281 5.162C16.648 16.844 14.819 18 12 18c-2.819 0-4.648-1.155-5.719-2.838C5.258 13.553 5 11.58 5 10a1 1 0 0 1 1-1z" fill="#000"/><path fill-rule="evenodd" clip-rule="evenodd" d="M12 16a1 1 0 0 1 1 1v4a1 1 0 1 1-2 0v-4a1 1 0 0 1 1-1zM9 5a3 3 0 1 1 6 0v1a1 1 0 1 1-2 0V5a1 1 0 1 0-2 0v5a1 1 0 1 1-2 0V5zM19.707 4.293a1 1 0 0 1 0 1.414l-14 14a1 1 0 0 1-1.414-1.414l14-14a1 1 0 0 1 1.414 0z" fill="#000"/></svg>
              : 
